    ...
    <div style={{ display:"flex", flexDirection:"column", height:"100%", minHeight:0 }}>
      ...
      <div style={{ display:"flex", flex:1, minHeight:0 }}>
        ...
        <div style={{ width:230, background:"#fff", borderLeft:"1px solid #e2e8f0", padding:"20px 16px", flexShrink:0, overflowY:"auto" }}>
          ...
          <button style={{ width:"100%", background:"#16a34a", color:"#fff", border:"none", borderRadius:8, padding:"11px 0", cursor:"pointer", fontSize:13, fontWeight:700, display:"flex", alignItems:"center", justifyContent:"center", gap:6 }}>⬇ Download PDF</button>
        </div>
      </div>
    </div>
  );
